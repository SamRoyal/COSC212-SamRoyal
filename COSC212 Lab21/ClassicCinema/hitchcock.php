    ...
    ?>
        <main>
            ...
            <section class="film">
                ...
                <p>The follow up to his box office sensation, <em>Psycho</em>, the Birds mixes suspense and horror from an everyday source.
                </p>
                <p>
            ...
            <section class="film">
                ...
                <p>Shot in 3D, but only released in 2D because of lack of interest in the process, it was shown in 3D in the 1980s, and has recently been released in 3D Blu-ray format.
                </p>
                <p>
            ...
            <section class="film">
                ...
                <p>Directed by: Alfred Hitchcock</p>
                <p>Starring: James Stewart, Doris Day, Brenda De Banzie, Bernard Miles, Alan Mowbray, Hillary Brooke, Christopher Olsen
                </p>
            ...
            <section class="film">
                ...
                <p>A classic thriller in which an innocent man is pursued by mysterious agents over government secrets.
                </p>
                <p>
                    $<span class="price">14.99</span>
                    <input type="button" value="Add to Cart" class="buy">
